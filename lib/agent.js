...
Agent.prototype.ensureConnection = function () {
  // Throw if the agent has not been started yet
  if (!this.isStarted()) throw new Error('ensureConnection must not be called before start')
